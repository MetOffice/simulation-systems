...
.. tab-set::
    ...
    .. tab-item:: LFRic Apps
        ...
        5. You can check the new kgo updated properly by retiggering tasks in the test suite. First retrigger
        ``export-source``, and then when complete ``export-source_ex1a`` if new checksums are present there
        ...
        if the kgo was updated in the working copy correctly.

        6. The changes in answers should be science reviewed by someone familiar with the failing tests -
