...
.. dropdown:: Is the ticket and testing complete?
    ...
    * It should be possible to understand the purpose of the ticket from the
    ...
    .. tip::
        ...
        * is there another rose-stem group that covers this area of code? See
          :ref:`um_testing` for common examples
...
.. dropdown:: Is this a :ref:`multi-repository<multirepo>` ticket?
    ...
    .. tip::
        ...
        should contain links to all the others and the correct keywords applied
...
documentation or code not meet the required standards and major
