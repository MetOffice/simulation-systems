...
problems with the head of the UM trunk (and its dependencies) before the release
process gets started in earnest.
...
* Open a pre-release testing ticket to record responses, issues etc (e.g., see
  `UM:#7795 <https://code.metoffice.gov.uk/trac/um/ticket/7795>`_.)
...
* Email the representatives at each UM partner site to them to test. A list of
  ...
  `UM Partner Testing Emails <https://code.metoffice.gov.uk/trac/um/wiki/UMPartnerTesting>`_
