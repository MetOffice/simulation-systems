...
* Copy ``rose-meta/jules-standalone/versions.py`` to an appropriately named
  ...
  .. code-block:: shell
    ...
    cp rose-meta/jules-standalone/versions.py rose-meta/jules-standalone/version58_59.py
...
* Login as julesadmin and create new KGO directories for the release by copying
  ...
  instructions
  <https://github.com/MetOffice/git_playground/wiki/Jules-KGO-Instructions>`_
