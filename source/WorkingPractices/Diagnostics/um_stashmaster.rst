...
..
  JW suggest need to include STASH entry guidance here. Maybe an issue for
...
* Although reservations could be some kind of self-service, contact the section
  owner first nevertheless. This could help to organise new items (when
  possible) in some logical groups.
...
You will need to identify the stash entry with a ``[stashmaster:code(xyz)]``
...
.. [#f1] This is an acronym for 'Spatial and Temporal Averaging and Storage
  Handling'.
