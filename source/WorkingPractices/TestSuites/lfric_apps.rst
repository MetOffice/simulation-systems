...
Local testing:
    ...
    This test does not require rose or cylc and is especially helpful for
    identifying compile errors during development.
...
.. important::
    ...
    * If setting the source to a Working Copy, the hostname needs to be provided
